...
<form method="post" class="woocommerce-ResetPassword lost_reset_password w-100 m-0 border-0 bg-EAF2F9 px-4 px-lg-5 dpt-50 dpb-50 radius20">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="woocommerce-Button btnA bg-88B3DA-btn aptly-bold font22 leading27 radius8 text-505050 d-inline-flex justify-content-center align-items-center text-uppercase text-decoration-none transition dmt-30 <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Reset password', 'woocommerce' ); ?>"><?php esc_html_e( 'Reset password', 'woocommerce' ); ?></button>
	</p>
