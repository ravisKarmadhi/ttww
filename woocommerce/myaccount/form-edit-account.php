...
<form class="woocommerce-EditAccountForm edit-account dmb-50" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<fieldset class="dmt-50">
		<legend class="aptly-bold font32 leading37 text-2F2F2F dmb-15"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>
	...
	<div>
		...
		<button type="submit" class="woocommerce-Button btnA bg-FDE5E9-btn aptly-bold font22 leading27 radius8 text-505050 d-inline-flex justify-content-center align-items-center text-uppercase text-decoration-none transition dmt-30<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
