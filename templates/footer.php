...
?>
    ...
    <footer class="footer">
        ...
        <div class="footer-main position-sticky bottom-0 -0 bg-1B2995 dpt-60 dpb-40">
            <div class="container">
                ...
                <div class="row justify-content-between">
                    <div class="col-4">
                        <div class="sans-medium font30 space-0_9 leading20 text-white dmb-25">
                    ...
                    <div class="col-3">
                        <div class="social-img-content d-flex justify-content-end dmb-55">
                        ...
                        <div class="d-flex justify-content-end">
                         <?php foreach($buttons as $button) :
                                ...
                                ?>
                            <a class="btnA white-border-btn sans-medium font16 space-0_48 leading26 rounded-pill text-decoration-none d-inline-flex justify-content-center align-items-center transition ms-3"
                ...
                <div class="row justify-content-between">
                    <div class="col-6 sans-normal font12 leading20 text-white">
                        <?php  echo $footer_text; ?>
                    </div>
                    <div class="col-6">
                        <ul class="list-none d-flex justify-content-end align-items-center mb-0 ps-0">
                            <?php foreach($footer_link_group as $footer_link_group_single) :
                                $footer_link_group_single_link = $footer_link_group_single['link'];
                                ?>
                            <li class="me-5">
                                <a class="sans-normal font12 leading20 text-decoration-none text-white" href="<?php echo $footer_link_group_single_link['url'] ?>"><?php echo $footer_link_group_single_link['title'] ?></a>
                            </li>
                          <?php endforeach; ?>
                        </ul>
                    </div>
