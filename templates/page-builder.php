                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-7 pe-lg-2">
                            <div class="left-right-slider-section position-relative tmb-25">
                        ...
                        <div class="col-lg-5">
                            <div class="col-lg-10 pe-lg-3 ms-auto">
                                ...
                                <div class="sans-normal font18 leading24 res-font16 text-191919 tmb-35 dmb-30 pe-3 pe-lg-0"><?php echo $content; ?></div>
                                <a href="<?php echo $link['url']; ?>"
                                    class="text-decoration-none btnA bg-1B2995-btn sans-medium font16 leading26 space-0_48 d-inline-flex align-items-center justify-content-center rounded-pill transition">
                                    <?php echo $link['title']; ?>
                                </a>
                                    ...
                                    ?>
                                        <?php if (!empty($link['url'])):
                                            ...
                                            <a href="<?php echo $link['url']; ?>" target="<?php echo $target_2; ?>"
                                                class="text-decoration-none btnA white-black-border-btn sans-medium font16 leading26 space-0_48 d-inline-flex align-items-center justify-content-center rounded-pill transition mx-2 mb-2 mb-lg-0">
                                                <?php echo $link['title']; ?>
                                            </a>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
